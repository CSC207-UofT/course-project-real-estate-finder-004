...
public class UserTest {
    ...
    @Test(timeout=50)
    public void TestUserGetUsername() { assert users[0].getUsername().equals("jsmith"); }

    @Test(timeout=50)
    public void TestUserGetEmail() { assert users[0].getEmail().equals("1234@gmail.com"); }

    @Test(timeout=50)
    public void TestUserGetPhone() { assert users[0].getPhone().equals("1234567890"); }
